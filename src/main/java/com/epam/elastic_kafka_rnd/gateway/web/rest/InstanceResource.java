...
import com.epam.elastic_kafka_rnd.gateway.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.epam.elastic_kafka_rnd.gateway.domain.Instance}.
 */
@RestController
@RequestMapping("/api")

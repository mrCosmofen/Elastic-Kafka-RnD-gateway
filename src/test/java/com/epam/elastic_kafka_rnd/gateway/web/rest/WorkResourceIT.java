...
import com.epam.elastic_kafka_rnd.gateway.repository.WorkRepository;
import com.epam.elastic_kafka_rnd.gateway.service.WorkService;
import com.epam.elastic_kafka_rnd.gateway.service.dto.WorkDTO;
import com.epam.elastic_kafka_rnd.gateway.service.mapper.WorkMapper;
...
public class WorkResourceIT {
    ...
    public void getNonExistingWork() throws Exception {
        // Get the work
        restWorkMockMvc.perform(get("/api/works/{id}", ))

...
import com.epam.elastic_kafka_rnd.gateway.repository.AgentRepository;
import com.epam.elastic_kafka_rnd.gateway.service.AgentService;
import com.epam.elastic_kafka_rnd.gateway.service.dto.AgentDTO;
import com.epam.elastic_kafka_rnd.gateway.service.mapper.AgentMapper;
...
public class AgentResourceIT {
    ...
    public void getNonExistingAgent() throws Exception {
        // Get the agent
        restAgentMockMvc.perform(get("/api/agents/{id}", ))

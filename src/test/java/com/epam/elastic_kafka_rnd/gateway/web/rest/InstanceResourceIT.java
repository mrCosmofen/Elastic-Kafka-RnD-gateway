package com.epam.elastic_kafka_rnd.gateway.web.rest;

import com.epam.elastic_kafka_rnd.gateway.GatewayApp;
import com.epam.elastic_kafka_rnd.gateway.config.SecurityBeanOverrideConfiguration;
import com.epam.elastic_kafka_rnd.gateway.domain.Instance;
import com.epam.elastic_kafka_rnd.gateway.repository.InstanceRepository;
import com.epam.elastic_kafka_rnd.gateway.service.InstanceService;
import com.epam.elastic_kafka_rnd.gateway.service.dto.InstanceDTO;
import com.epam.elastic_kafka_rnd.gateway.service.mapper.InstanceMapper;
import com.epam.elastic_kafka_rnd.gateway.web.rest.errors.ExceptionTranslator;
...
import static com.epam.elastic_kafka_rnd.gateway.web.rest.TestUtil.createFormattingConversionService;
...
public class InstanceResourceIT {
    ...
    public void getNonExistingInstance() throws Exception {
        // Get the instance
        restInstanceMockMvc.perform(get("/api/instances/{id}", ))
